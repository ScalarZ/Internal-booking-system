...
import {
  updateDomesticDeparturesRepresentative,
  updateDomesticDeparturesBus,
  updateDomesticDeparturesDriver,
  updateDomesticDeparturesNote,
...
const NoteCell = ({
  ...
  const handleSave = async () => {
    ...
    setOpen(false);
    await updateDomesticDeparturesNote(
      row.original.id,
      row.original.domesticId,
      note,
    );
  ...
  // Add the new columns
  {
    ...
    cell: ({ row }) => (
      <SelectCell
        ...
        type="representative"
        updateFunction={updateDomesticDeparturesRepresentative}
      />
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <SelectCell
        ...
        options={buses}
        type="bus"
        updateFunction={updateDomesticDeparturesBus}
      />
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <SelectCell
        ...
        options={drivers}
        type="driver"
        updateFunction={updateDomesticDeparturesDriver}
      />
    ),
  },
  {
