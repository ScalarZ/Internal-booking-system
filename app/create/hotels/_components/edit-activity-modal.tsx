...
import { updateHotel } from "@/utils/db-queries/hotel";
...
export default function EditActivityModal({
  ...
  initialValues: SelectHotelsWithCitiesAndCountries;
  ...
  async function handleAddCountry(e: FormEvent) {
    ...
    setIsLoading(true);
    try {
      await updateHotel({ name, countryId, cityId, id: initialValues.id });
    } catch (err) {
      console.error(err);
    } finally {
      setIsLoading(false);
