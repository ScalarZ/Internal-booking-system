...
import { addNileCruise } from "@/utils/db-queries/nile-cruise";

export default function CreateNileCruiseButton() {
  ...
  async function handleAddNileCruise(e: FormEvent) {
    e.preventDefault();
    resetErrorMessage();
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Add New Nile Cruise</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleAddNileCruise}>
