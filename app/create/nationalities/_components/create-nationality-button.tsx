...
import { addNationality } from "@/utils/db-queries/nationality";

export default function CreateNationalityButton() {
  ...
  async function handleAddNationality(e: FormEvent) {
    e.preventDefault();
    resetErrorMessage();
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Add New Nationality</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleAddNationality}>
